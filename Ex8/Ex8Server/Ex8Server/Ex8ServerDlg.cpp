...
CEx8ServerDlg::CEx8ServerDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CEx8ServerDlg::IDD, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CEx8ServerDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
...
BEGIN_MESSAGE_MAP(CEx8ServerDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_SEND, &CEx8ServerDlg::OnBnClickedSend)
END_MESSAGE_MAP()


// CEx8ServerDlg 消息处理程序
...
void CEx8ServerDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//显示。
HCURSOR CEx8ServerDlg::OnQueryDragIcon()
{
